...
public class ChildCancelButtonScript : MonoBehaviour
{
    //AnswerClickActionを宣言
    private ChildAnswerClickAction answerClickAction; 
    //決定ボタン
    ...
    {
        //各種オブジェクトを取得
        answerClickAction = GameObject.Find("Canvas").GetComponent<ChildAnswerClickAction>();
